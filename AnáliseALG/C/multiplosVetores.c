 ...
 *@params: Apontador para primeira posicao de vetor de inteiros, inteiro "seed" contendo o valor da semente 
 */
 ...
 *@params: Apontador para primeira posicao de vetor de reais longos (double), inteiro relativo ao tamanho do array
...
int main(){
	...
	//Definindo os vetores para reter os resultados das análises

    clock_t inicio, fim;
    double tempo;

    double* tempos_quick_62  =  (double*) malloc(sizeof(double)*50);

    double* tempos_quick_125 = (double*) malloc(sizeof(double)*50);

    double* tempos_quick_250 = (double*) malloc(sizeof(double)*50);

    double* tempos_quick_375 = (double*) malloc(sizeof(double)*50);

    double* tempos_selec_62  =  (double*) malloc(sizeof(double)*50);

    double* tempos_selec_125 = (double*) malloc(sizeof(double)*50);

    double* tempos_selec_250 = (double*) malloc(sizeof(double)*50);

    double* tempos_selec_375 = (double*) malloc(sizeof(double)*50);


	
    //Bloco 62.500

    int* arrQuick = (int*) malloc(sizeof(int)*ARR_SIZE_62);

    int* arrSelec = (int*) malloc(sizeof(int)*ARR_SIZE_62);
    ...
    printf("Seleção 62.500: 0 %% concluido\n");
    ...
    for(int i = 0; i < 50; i++){
        ...
        printf("Seleção 62.500: %d %% concluido\n",(i+1)*2);
        fflush(stdout);
    ...
    arrQuick = (int*) malloc(sizeof(int)*ARR_SIZE_125);

    arrSelec = (int*) malloc(sizeof(int)*ARR_SIZE_125);
    ...
    printf("Seleção 125.000: 0 %% concluido\n");
    ...
    for(int i = 0; i < 50; i++){
        ...
        printf("Seleção 125.000: %d %% concluido\n",(i+1)*2);
        fflush(stdout);
    ...
    arrQuick = (int*) malloc(sizeof(int)*ARR_SIZE_250);

    arrSelec = (int*) malloc(sizeof(int)*ARR_SIZE_250);
    ...
    printf("Seleção 250.000: 0 %% concluido\n");
    ...
    for(int i = 0; i < 50; i++){
        ...
        printf("Seleção 250.000: %d %% concluido\n",(i+1)*2);
        fflush(stdout);
    ...
    arrQuick = (int*) malloc(sizeof(int)*ARR_SIZE_375);

    arrSelec = (int*) malloc(sizeof(int)*ARR_SIZE_375);
    ...
    printf("Seleção 375.000: 0 %% concluido\n");
    ...
    for(int i = 0; i < 50; i++){
        ...
        printf("Seleção 375.000: %d %% concluido\n",(i+1)*2);
        fflush(stdout);
